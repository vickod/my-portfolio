...
export default function Technologies() {
  return (
    <div className="pt-10 mt-40 text-zinc-700 dark:text-zinc-300" id="techno">
      <h1 className="text-4xl mb-20 font-bold dark:text-zinc-300 text-zinc-800">
        Technologies
      </h1>
      <div className="flex flex-col gap-10">
        <div className="">
          ...
          <div className="flex gap-3 mt-4 flex-wrap max-lg:justify-start">
            <div className="flex items-center gap-1 bg-gray-100 dark:bg-gray-900 dark:text-zinc-300 px-4 rounded-lg">
