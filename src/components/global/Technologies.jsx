      ...
      <div className="flex flex-col gap-20">
        <div className="">
          ...
          <div className="flex gap-3 mt-4 flex-wrap max-lg:justify-start">
            ...
            <div className="flex items-center gap-1 dark:bg-zinc-900 bg-zinc-100 dark:text-zinc-300 px-4 rounded-lg">
              <TbBrandTypescript className="min-w-[40px] min-h-[40px] text-blue-900" />
              <p>TypeScript</p>
            </div>
            <div className="flex items-center gap-1 dark:bg-zinc-900 bg-zinc-100 dark:text-zinc-300 px-4 rounded-lg">
              <BiLogoTailwindCss className="min-w-[40px] min-h-[40px] text-cyan-700" />
              <p>Tailwind</p>
            </div>
            <div className="flex items-center gap-1 dark:bg-zinc-900 bg-zinc-100 dark:text-zinc-300 px-4 rounded-lg">
        ...
        <div className="">
          <h3 className="text-2xl">Divers:</h3>
          <div className="flex gap-3 mt-4 flex-wrap">
            <div className="flex items-center gap-1 dark:bg-zinc-900 bg-zinc-100 dark:text-zinc-300 px-4 rounded-lg">
            ...
            <div className="flex items-center gap-1 dark:bg-zinc-900 bg-zinc-100 dark:text-zinc-300 px-4 rounded-lg">
              <AiOutlineOpenAI className="min-w-[40px] min-h-[40px] text-green-300" />
              <p>Chat GPT</p>
            </div>
            <div className="flex items-center gap-1 dark:bg-zinc-900 bg-zinc-100 dark:text-zinc-300 px-4 rounded-lg">
